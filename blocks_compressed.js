  ...
  customContextMenu: function (a) {
    ...
    if (!this.isCollapsed())
      for (e = 0; e < this.arguments_.length; e++) b = {
        enabled: !0
      }, c = this.arguments_[e], b.text = Blockly.Msg.VARIABLES_SET_CREATE_GET.replace("%1", c), d = goog.dom.createDom("field", null, c), d.setAttribute("name", "VAR"), d = goog.dom.createDom("block", null, d), d.setAttribute("type",
...
Blockly.Blocks.procedures_callnoreturn = {
  ...
  setProcedureParameters_: function (a, b) {
    ...
    var e = d && d.mutator && d.mutator.isVisible();
    ...
    if (b)
      if (goog.array.equals(this.arguments_, a)) this.quarkIds_ = b;
        ...
        for (var f = 0; f < this.arguments_.length; f++)
          if (c = this.getInput("ARG" + f)) c = c.connection.targetConnection, this.quarkConnections_[this.quarkIds_[f]] = c, e && c && -1 == b.indexOf(this.quarkIds_[f]) && (c.disconnect(), c.getSourceBlock().bumpNeighbours_());
        this.arguments_ = [].concat(a);
        this.updateShape_();
        if (this.quarkIds_ = b)
          for (f = 0; f < this.arguments_.length; f++) e =
...
Blockly.Extensions.register("text_quotes", Blockly.Constants.Text.textQuotesExtension);
Blockly.Blocks.text_join = {
  ...
  compose: function (a) {
    ...
    for (b = 0; b < this.itemCount_; b++) {
      var c =
        this.getInput("ADD" + b).connection.targetConnection;
      c && -1 == a.indexOf(c) && c.disconnect()
    }
    this.itemCount_ = a.length;
    this.updateShape_();
  ...
  updateShape_: function () {
    this.itemCount_ && this.getInput("EMPTY") ? this.removeInput("EMPTY") :
      this.itemCount_ || this.getInput("EMPTY") || this.appendDummyInput("EMPTY").appendField(this.newQuote_(!0)).appendField(this.newQuote_(!1));
    for (var a = 0; a < this.itemCount_; a++)
      if (!this.getInput("ADD" + a)) {
        var b = this.appendValueInput("ADD" + a);
...
Blockly.Blocks.original = {};
Blockly.Constants.Original = {};
Blockly.Constants.Original.HUE = 200;
Blockly.Blocks.original.HUE = Blockly.Constants.Original.HUE;
Blockly.defineBlocksWithJsonArray([
  {
    "type": "original_add",
    "message0": "add %1 a %2 b %3",
    "args0": [
      {
        "type": "input_dummy"
      },
  ...
  {
    "type": "original_add_pin",
    "message0": "add pin %1 x %2 y %3",
    "args0": [
      {
        "type": "input_dummy"
      },
