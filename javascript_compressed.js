...
Blockly.JavaScript.lists_getSublist = function (a) {
  ...
  if ("FIRST" == c && "LAST" == d) var e = b + ".slice(0)";
    ...
    f = Blockly.JavaScript.provideFunction_("subsequence" + g[c] + g[d], ["function " + Blockly.JavaScript.FUNCTION_NAME_PLACEHOLDER_ + "(sequence" + ("FROM_END" == c || "FROM_START" == c ? ", at1" : "") + ("FROM_END" == d || "FROM_START" == d ? ", at2" : "") + ") {", "  var start = " + f("sequence", c, "at1") + ";", "  var end = " + f("sequence", d, "at2") + " + 1;", "  return sequence.slice(start, end);", "}"]);
    e = f + "(" + b + ("FROM_END" == c || "FROM_START" == c ? ", " + e : "") + ("FROM_END" ==
      d || "FROM_START" == d ? ", " + a : "") + ")"
  }
...
Blockly.JavaScript.text_changeCase = function (a) {
  ...
  b ? b = a + b : (b = Blockly.JavaScript.provideFunction_("textToTitleCase", ["function " + Blockly.JavaScript.FUNCTION_NAME_PLACEHOLDER_ + "(str) {", "  return str.replace(/\\S+/g,", "      function(txt) {return txt[0].toUpperCase() + txt.substring(1).toLowerCase();});",
"}"]), b = b + "(" + a + ")");
...
Blockly.JavaScript.original = {};
Blockly.JavaScript.original_add = function (a) {
  var e = Blockly.JavaScript.ORDER_ADDITION;
  var b = Blockly.JavaScript.valueToCode(a, "in_a", e);
  var c = Blockly.JavaScript.valueToCode(a, "in_b", e);

  return ["hello()"]
};
Blockly.JavaScript.original_ave = function (a) {
  var e = Blockly.JavaScript.ORDER_ADDITION;
  var b = Blockly.JavaScript.valueToCode(a, "in_a", e);
  var c = Blockly.JavaScript.valueToCode(a, "in_b", e);
...
Blockly.JavaScript.original_add_pin = function (a) {
  var e = Blockly.JavaScript.ORDER_ADDITION;
  var b = Blockly.JavaScript.valueToCode(a, "in_x", e);
  var c = Blockly.JavaScript.valueToCode(a, "in_y", e);

  return ["L.marker([" + b + "," + c + "]).addTo(map)"]
};
